    ...
    return (
        <section id="about" className="flex flex-col items-center gap-6 md:gap-16 mt-12 max-sm:h-[480px] md:mt-28">
            <div className="md:grid md:grid-cols-2 md:justify-center w-full md:w-[1120px] h-[219px] md:h-[337px]">
                <div className="max-sm:hidden w-[455px] h-full  rounded-md">
                    <Image src="/images/About2.png" alt="" height={455} width={455} className="w-full h-full rounded-xl" />
                </div>
            ...
            <div className="md:grid md:grid-cols-2 md:justify-center w-full md:w-[1120px] h-[219px] md:h-[337px] max-sm:mt-10">
                <div className="flex flex-col justify-center gap-4 max-sm:m-auto max-sm:p-2 max-sm:pl-4 w-auto md:w-[500px] h-auto">
                ...
                <div className="max-sm:hidden ml-20 w-[455px] h-full rounded-md">
                    <Image src="/images/About1.png" alt="" height={455} width={455} className="w-full h-full rounded-xl" />
                </div>
            </div>
        </section>
    )
