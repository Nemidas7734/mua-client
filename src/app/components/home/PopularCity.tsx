...
export default function PopularCity() {
    return (
        <div className="flex flex-col justify-center items-center h-[160px] md:h-[340px] bg-gradient-to-r from-[#F27BBD] to-[#FFFFFF]">
            <h2 className="mx-auto font-bold text-xl md:text-3xl">POPULAR CITIES</h2>
            <div className="relative flex justify-center items-center gap-6 md:gap-10 w-[427px] md:w-[1167px] h-20 md:h-[104px] border-b-2 rounded-full bg-pink-200 mt-6">
