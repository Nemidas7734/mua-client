...
export default function Footer() {
    return (
        <section className="flex flex-col items-center justify-between mt-24 w-full bg-[#001B79] h-[500px]">
            <div className="flex-col justify-center">
                <div className="grid grid-cols-9 mt-20 w-[1120px]">
                    ...
                    <div className="col-span-2 pl-4 flex flex-col">
                        <p className="font-normal w-[187px] text-sm text-wrap text-white">Are you a makeup artist ? Join the MUA community and spread your business all across your city.</p>
                    ...
                    <div className="col-span-2 pl-14">
                        ...
                        <div className="flex flex-col gap-1 mt-1">
                            <div className="flex items-center gap-1">
                                ...
                                <h1 className="text-white text-sm font-normal">Facebook</h1>
                            </div>
                            <div className="flex items-center gap-1">
                                <Image src="/icons9-twitterx.png" alt="" width={20} height={20} className="" />
                                <h1 className="text-white text-sm font-normal">Twitter</h1>
                            </div>
                            <div className="flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 48 48">
                                ...
                                <h1 className="text-white text-sm font-normal">Pinterest</h1>
                            </div>
                            <div className="flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 48 48">
                                ...
                                <h1 className="text-white text-sm font-normal">Instagram</h1>
                            </div>
                            <div className="flex items-center gap-1">
                                <Image src="/icons8-snapchat.svg" alt="" width={20} height={20} className="" />
                                <h1 className="text-white text-sm font-normal">Snapchat</h1>
                            </div>
                            <div className="flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 48 48">
                                    <path fill="#FF3D00" d="M43.2,33.9c-0.4,2.1-2.1,3.7-4.2,4c-3.3,0.5-8.8,1.1-15,1.1c-6.1,0-11.6-0.6-15-1.1c-2.1-0.3-3.8-1.9-4.2-4C4.4,31.6,4,28.2,4,24c0-4.2,0.4-7.6,0.8-9.9c0.4-2.1,2.1-3.7,4.2-4C12.3,9.6,17.8,9,24,9c6.2,0,11.6,0.6,15,1.1c2.1,0.3,3.8,1.9,4.2,4c0.4,2.3,0.9,5.7,0.9,9.9C44,28.2,43.6,31.6,43.2,33.9z"></path><path fill="#FFF" d="M20 31L20 17 32 24z"></path>
                                </svg>
                                <h1 className="text-white text-sm font-normal">Youtube</h1>
                            </div>
                        </div>
                    </div>
                    <hr className="h-px my-10 w-[1100px] bg-white border-0 dark:bg-gray-700"></hr>
                </div>
                <div className="flex justify-evenly mt-8">
                    <strong className="text-7xl text-[#EA2793]">MUA</strong>
                    <div className="flex flex-col text-white text-base font-bold justify-center">
                        <h1>Contact Us:</h1>
            ...
            <div className="w-full h-8 bg-[#706C6C] flex justify-center items-center">
                <h1 className="font-bold text-sm text-black">Copyright&copy; 2024</h1>
            </div>
        </section>
    )
}