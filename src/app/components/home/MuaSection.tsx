      ...
      <div>
        ...
        <div className='flex flex-col mt-10 md:mt-16 m-auto items-center max-w-[350px] md:max-w-[658px] h-44 md:h-[300px] text-wrap'>
          ...
          <Link href="/pages/artistlisting">
            <button className="bg-[#EA2793] w-24 md:w-28 h-6 md:h-7 rounded-full text-white font-semibold text-xs md:text-sm mt-7 md:mt-8 hover:shadow-md hover:shadow-[#F27BBD]">Check Out !</button>
          </Link>
        </div>
