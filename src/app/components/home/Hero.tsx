    ...
    return (
        <div className="relative">
            ...
            <div className="absolute p-6 max-w-[265px] md:max-w-[565px] text-wrap top-1/4 md:top-48 left-5 sm:left-20 z-20">
                <h1 className="font-normal text-[10px] md:text-xs sm:mb-2 md:mb-0 text-white">&quot;Discover Beauty at Your Doorstep with MUA: Your Personal Makeup Artist Awaits.&quot;</h1>
